      ...
      <section>
        <Row className="scottish-row align-items-center justify-content-center text-white py-5 product-divider">
          <div class="divider-top-RED p-0">
            ...
            >
              <path d="M1200 120L0 16.48 0 0 1200 0 1200 120z" class="RED-fill"></path>
            </svg>
          </div>
          ...
          <div class="divider-bottom-VIOLET p-0">
            <svg
              data-name="Layer 1"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 1200 120"
              preserveAspectRatio="none"
            >
              <path d="M1200 120L0 16.48 0 0 1200 0 1200 120z" class="VIOLET-fill"></path>
            </svg>
          </div>
        </Row>
      </section>
